...
![GetProductsByPriceRangeHandler Code](GetProductsByPriceRangeHandler.png)

**GetProductsByPriceRangeEndpoint.cs** (Carter Endpoint MapGet nhận query string)
![GetProductsByPriceRangeEndpoint Code](GetProductsByPriceRangeEndpoint.png)
...
![GetProductsByPriceRange Postman Result](GetProductsByPriceRange_Postman.png)
...
![GetOrdersByStatusQuery Code](GetOrdersByStatusQuery.png)

**GetOrdersByStatusHandler.cs** (Xử lý filter trạng thái qua EF Core DbContext)
![GetOrdersByStatusHandler Code](GetOrdersByStatusHandler.png)

**GetOrdersByStatus.cs** (Carter Endpoint nhận biến route `{status}`)
![GetOrdersByStatusEndpoint Code](GetOrdersByStatusEndpoint.png)
...
![GetOrdersByStatus Postman Result](GetOrdersByStatus_Postman.png)
